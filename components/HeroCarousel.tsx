  ...
  return (
    <div className="relative h-96 md:h-[500px] overflow-hidden rounded-lg shadow-lg">
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-40 text-white"
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-40 text-white"
        onClick={goToNext}
      >
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
        ...
        <div className="max-w-4xl relative z-10">
          <div className="mb-6 bg-black bg-opacity-30 rounded-lg p-8 backdrop-blur-sm border border-white border-opacity-20">
